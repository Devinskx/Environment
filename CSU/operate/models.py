...
#     s_temperature = models.IntegerField(default=0)
#     s_humidity = models.IntegerField(default=0)
#     s_co2 = models.IntegerField(default=0)
#     s_pm = models.IntegerField(default=0)
